	...
	return (
		<div>
			<div className="grid grid-cols-6 md:gap-4 md:grid-cols-12">
				...
				<div className="relative col-span-6 gap-4 grid md:grid-cols-12 grid-cols-6 border rounded-md shadow-sm border-ocoblue-500/30 p-2">
