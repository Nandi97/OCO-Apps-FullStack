		...
		<div className="fixed top-0 left-0 z-[100] w-full h-full bg-white font-roboto">
			<div className="flex w-full flex-col items-center">
				...
				<div className="bg-transparent flex items-center space-x-4 -mt-14">
					<div className="overflow-hidden h-28 w-28 ring-4 bg-white ring-ocoblue-500/50 rounded-full">
						{!staff?.avatarUrl ? (
							<span className="inline-flex items-center justify-center rounded-full h-full w-full bg-ocoblue-50">
								<span className="font-semibold leading-none text-ocoblue-600 text-5xl">
									{staff?.name
										.split(' ')
										.slice(0, 2)
										.map((n) => n[0])
					...
					<div className="flex flex-col text-ocoblue-700">
						<h1 className="text-2xl font-medium text-ocoblue-50">{staff?.name}</h1>
						...
						<tbody>
							<tr className=" bg-ocoblue-700/20 border-b-4 border-white">
								...
								<td className="flex flex-col w-5/6 text-sm">
									<span className="font-medium text-ocoblue-700">
										Direct Line
									</span>
							...
							<tr className=" bg-ocoblue-700/20 border-b-4 border-white">
								...
								<td className="flex flex-col w-5/6 text-sm">
									<span className="font-medium text-ocoblue-700">Mobile</span>
							...
							<tr className=" bg-ocoblue-700/20 border-b-4 border-white">
								...
								<td className="flex flex-col w-5/6 text-sm">
									<span className="font-medium text-ocoblue-700">Email</span>
							...
							<tr className=" bg-ocoblue-700/20 border-b-4 border-white">
								...
								<td className="flex flex-col w-5/6 text-sm">
									<span className="font-medium text-ocoblue-700">Website</span>
